#' @title Imports
#' 
#' These directives help roxygen2 successfully create the NAMEPSPACE file.
#' Since these ones are widely used they were included in this file, but ideally
#' they should all go to the roxygen skeleton of the functions which use them.
#' 
#' @name imports
#' 
