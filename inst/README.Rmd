...
You can also install the [development version](https://github.com/mixOmicsTeam/mixOmics/blob/devel/DESCRIPTION#L4) for new features yet to be widely tested:
```{r}
if (BiocManager::version() >= package_version('3.11')) 
{
