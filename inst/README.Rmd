...
`r latest_stable_badge`
`r latest_stable_build`
`r latest_devel_badge`
`r latest_devel_build`
...
Check after installation that the following code does not throw any error (especially Mac users - refer to [installation instructions](#installation)) and that the welcome message confirms you have installed `r latest_stable_badge`:
...
You can also install the development version (`r latest_devel_badge`) for new features yet to be widely tested:
```{r}
