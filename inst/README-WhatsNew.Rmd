...
Also explored potential bugs in handling of near zero variance in `block.splsda` [#352](https://github.com/mixOmicsTeam/mixOmics/issues/352) and of `perf()` giving incorrect per-class error rates [#355](https://github.com/mixOmicsTeam/mixOmics/issues/355).
